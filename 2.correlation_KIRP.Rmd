---
title: "A correlation analysis of clinical variables of TCGA-KIRP patients"
output: 
  html_document: 
    default
  github_document: 
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE}
kirp_clin <- read_csv("C:/Users/Ericd/Documents/KIRP Analisys/TCGA-CBIOPORTAL-DATA/kirp_clean.csv")
```
